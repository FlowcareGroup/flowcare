...
export default function DoctorDashboard({
  ...
  const StatCard = ({
    ...
    <div className='card flex items-center gap-4 p-2'>
      <div
        className={`${color} hidden shrink-0 sm:flex items-center justify-center w-10 h-10 rounded-lg text-white`}
      >
    ...
    <div className='mb-12'>
      ...
      <div className='mb-8'>
        <div className='flex items-center justify-between mb-4'>
          <h2 className='text-sm sm:text-xl font-bold text-darker'>
            Estadísticas de Hoy
          </h2>
          <button
      ...
      <div>
        <h2 className='text-xl font-bold text-darker mb-4'>
