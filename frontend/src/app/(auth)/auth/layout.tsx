...
export default function AuthLayout({
  ...
  return (
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[url('/fc7257a5bffaea6a2bc3afa30989fadd7e413f85.jpg')] bg-cover bg-center bg-linear-300 ">
